...
public class GeneticOperators {
    ...
    public static ArrayList<Individual> localSearchOperatorFitness(ArrayList<Individual> individuals) {
        ...
        for (int i = 0; i < individuals.size(); i++) {
            ...
            Individual individual = individuals.get(i);
            double previousFitness = individual.getFitness();
    ...
    public static ArrayList<Individual> mutation(ArrayList<Individual> children) {
        ...
        for (int i = 0; i < indexChildrenMutation.size(); i++) {
            ...
            //Results.printRule(children.get(indexIndividual).getRule());
            ...
            if (generator.nextDouble() <= 0.5) {
                ...
                //System.out.println("After flag mutation");
                //Results.printRule(children.get(indexIndividual).getRule());
                ...
                //System.out.println("After generalization/restriction mutation");
                //Results.printRule(children.get(indexIndividual).getRule());
            }
        }
        return children;
